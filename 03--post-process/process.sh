...
echo $cmd; eval $cmd
../utils/qc.sh intermediate/07.txt 2
...
echo $cmd; eval $cmd
../utils/qc.sh intermediate/13.txt 1-8
fi
cmd="cp intermediate/12.txt output/geneExpression$myDate.txt; ../utils/txt2excel.py output/geneExpression$myDate.txt"
echo $cmd; eval $cmd
